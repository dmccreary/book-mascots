...
-   **[Learning Sciences](mascots/learning-sciences/index.md)**
    ...
    ![Bloom the Elephant](mascots/learning-sciences/neutral.png){ width=220 }
...
-   **[Moving Rainbow](mascots/moving-rainbow/index.md)**
    ...
    ![Pixel the Addressable LED](mascots/moving-rainbow/neutral.png){ width=220 }
...
-   **[Pre Calc](mascots/pre-calc/index.md)**
    ...
    ![Prema](mascots/pre-calc/neutral.png){ width=220 }

    Prema

-   **[Prompt Class](mascots/prompt-class/index.md)**

    ![Polly the Parrot](mascots/prompt-class/neutral.png){ width=220 }

    Polly the Parrot

-   **[Psychology](mascots/psychology/index.md)**

    ![Psy the Owl](mascots/psychology/neutral.png){ width=220 }

    Psy the Owl

-   **[Introduction to Public Health](mascots/public-health/index.md)**

    ![Sage the Crane](mascots/public-health/neutral.png){ width=220 }

    Sage the Crane

-   **[Quantum Computing](mascots/quantum-computing/index.md)**

    ![Fermi the Ferret](mascots/quantum-computing/neutral.png){ width=220 }
...
-   **[Semiconductor Physics Course](mascots/semiconductor-physics-course/index.md)**
    ...
    ![Nova the Electron Sprite](mascots/semiconductor-physics-course/neutral.png){ width=220 }

    Nova the Electron Sprite

-   **[Statistics Course](mascots/statistics-course/index.md)**

    ![Sylvia the Statistical Squirrel](mascots/statistics-course/neutral.png){ width=220 }

    Sylvia the Statistical Squirrel

-   **[STEM Robots](mascots/stem-robots/index.md)**

    ![Sparky the Robot](mascots/stem-robots/neutral.png){ width=220 }
...
-   **[Token Efficiency](mascots/token-efficiency/index.md)**
    ...
    ![Pemba the Red Panda](mascots/token-efficiency/neutral.png){ width=220 }

    Pemba the Red Panda

-   **[Unicorns](mascots/unicorns/index.md)**

    ![Sparkle the Unicorn](mascots/unicorns/neutral.png){ width=220 }

    Sparkle the Unicorn

-   **[U.S. Government](mascots/us-government/index.md)**

    ![Lex the Bald Eagle](mascots/us-government/neutral.png){ width=220 }

    Lex the Bald Eagle

-   **[U.S. History](mascots/us-history/index.md)**

    ![Liberty the Bald Eagle](mascots/us-history/neutral.png){ width=220 }
